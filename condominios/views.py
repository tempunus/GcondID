...
class CondominiumListView(AdminRequiredMixin, ListView):
    model = Condominium
    template_name = "condominios/condominium_list.html"
    context_object_name = "condominiums"


class CondominiumCreateView(AdminRequiredMixin, CreateView):
    model = Condominium
...
class CondominiumUpdateView(AdminRequiredMixin, UpdateView):
    model = Condominium
    form_class = CondominiumForm
    template_name = "condominios/condominium_form.html"
    success_url = reverse_lazy("condominios:list")
...
class CondominiumDeleteView(AdminRequiredMixin, DeleteView):
    model = Condominium
